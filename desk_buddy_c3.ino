...
// --- WEATHER ICONS ---
const unsigned char bmp_clear[] PROGMEM = {  };
const unsigned char bmp_clouds[] PROGMEM = { 	 };
const unsigned char bmp_rain[] PROGMEM = {  };

const unsigned char mini_sun[] PROGMEM = { 0x01, 0x80, 0x01, 0x80, 0x31, 0x8c, 0x38, 0x1c, 0x13, 0xc8, 0x07, 0xe0, 0x0f, 0xf0, 0xef, 0xf7, 0xef, 0xf7, 0x0f, 0xf0, 0x07, 0xe0, 0x13, 0xc8, 0x38, 0x1c, 0x31, 0x8c, 0x01, 0x80, 0x01, 0x80
 };
const unsigned char mini_cloud[] PROGMEM = {0x00, 0x00, 0x00, 0x00, 0x03, 0x80, 0x0c, 0x40, 0x18, 0xf8, 0x31, 0x0c, 0x63, 0x06, 0x86, 0x02, 0x88, 0x02, 0x90, 0x03, 0x70, 0x01, 0x10, 0x03, 0x1c, 0x03, 0x07, 0xfe, 0x00, 0x00, 0x00, 0x00 };
const unsigned char mini_rain[] PROGMEM = { 0x07, 0x00, 0x1f, 0x80, 0x1f, 0xf0, 0x3f, 0xf8, 0x7f, 0xfc, 0xff, 0xfe, 0xff, 0xfe, 0xff, 0xff, 0xff, 0xff, 0x7f, 0xfe, 0x3f, 0xfc, 0x00, 0x00, 0x33, 0x30, 0x62, 0x20, 0x46, 0x60, 0xcc, 0x40 };
...
const unsigned char bmp_zzz[] PROGMEM = { 0x00, 0x00, 0x00, 0x00, 0x01, 0xfc, 0x00, 0xfc, 0x00, 0x38, 0x00, 0x78, 0x00, 0xe0, 0x01, 0xfc, 0x00, 0xfc, 0x00, 0x00, 0x7c, 0x00, 0x0c, 0x00, 0x18, 0x00, 0x34, 0x00, 0x7c, 0x00, 0x00, 0x00 };
const unsigned char bmp_anger[] PROGMEM = { 0x10, 0x08, 0x18, 0x18, 0x0c, 0x30, 0x46, 0x63, 0x63, 0xc6, 0x30, 0x0c, 0x18, 0x18, 0x08, 0x18, 0x18, 0x10, 0x18, 0x18, 0x30, 0x0c, 0x63, 0x87, 0xc6, 0x63, 0x0c, 0x30, 0x30, 0x18, 0x20, 0x08 };
...
void loadConfig() {
  ...
  wifiSsid    = prefs.getString("ssid", "Daewoo");
  wifiPass    = prefs.getString("pass", "672331222");
  apiKey      = prefs.getString("apikey", "5eb42c7e759545ef648bc635391196b5");
  city        = prefs.getString("city", "Gulistan");
  countryCode = prefs.getString("country", "UZ");
  tzString    = prefs.getString("tz", "UZT-5");
  prefs.end();
}
...
void handleConfigRoot() {
  ...
  String sCity = prefs.getString("city", "Gulistan");
  String sCtry = prefs.getString("country", "UZ");
  String sTz   = prefs.getString("tz", "UZT-5");
  prefs.end();
...
void handleConfigSave() {
  ...
  prefs.begin("deskbuddy", true);
  if (ak.isEmpty())  ak  = prefs.getString("apikey", "5eb42c7e759545ef648bc635391196b5");
  if (cty.isEmpty()) cty = prefs.getString("city", "Gulistan");
  if (ctr.isEmpty()) ctr = prefs.getString("country", "UZ");
  if (tz.isEmpty())  tz  = prefs.getString("tz", "UZT-5");
  prefs.end();
...
void drawWorldClock() {
  ...
  time(&now);
  // Tokyo UTC+9
  time_t tokyoEpoch = now + (9 * 3600);
  // Germany UTC+2 (summer time)
  time_t germanyEpoch = now + (2 * 3600);
  struct tm tokyoTm;
  struct tm germanyTm;
  gmtime_r(&tokyoEpoch, &tokyoTm);
  gmtime_r(&germanyEpoch, &germanyTm);
  int t_h = tokyoTm.tm_hour;
  int t_m = tokyoTm.tm_min;
  int g_h = germanyTm.tm_hour;
  int g_m = germanyTm.tm_min;
